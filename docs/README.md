...
- [Server Core](./server-core.md) - transport shell, app-facing bootstrap config boundary, the bootstrap-time `AppBootstrapConfig::global_prefix()` helper, and current TLS/runtime boundaries, with the SCXML request-pipeline gate kept explicit.
