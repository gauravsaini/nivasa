...
- [Server Core](./server-core.md) - transport shell, app-facing builder config, and current TLS/runtime boundaries, with the SCXML request-pipeline gate kept explicit.
